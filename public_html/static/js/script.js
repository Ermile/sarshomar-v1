...
// Range Slider
!function(a){a.fn.ermile_slider=function(){a(this).each(function(){a(this).addClass("range-slider");var c=a(this).attr("id");c&&(a('<input type="hidden" name="'+c+'-max" data-range-bind="'+c+'" data-range-value="max">').appendTo(this),a('<input type="hidden" name="'+c+'-min" data-range-bind="'+c+'" data-range-value="min">').appendTo(this));var d=a(this).attr("data-infinity"),e=a(this).attr("data-type");"vertical"!=e&&(e="horizontal",a(this).attr("data-type","horizontal"));var f=Number(a(this).attr("data-step"));isNaN(f)&&(f=1);var g=Number(a(this).attr("data-min"));isNaN(g)&&(g=0);var h=Number(a(this).attr("data-max"));(isNaN(h)||g>=h)&&(h=g+100);var i=h-g,j=Number(a(this).attr("data-min-default"));(isNaN(j)||j<g)&&(j=0);var k=Number(a(this).attr("data-max-default"));(isNaN(k)||h<k)&&(k=i),a(this).data("range-slider",{min:g,max:h,min_default:j,max_default:k,unit:i,step:f,type:e,margin:j,depth:h}),a(this).init.prototype.range=function(b,c,d){var e=b,f=c,g=this.data("range-slider");option={type:"unit"},a.extend(option,d),option.from_type=option.type,option.to_type=option.type;var h="vertical"==g.type?"height":"width";null!==e&&e!==!1&&void 0!==e||(e=this.find(".dynamic-margin")[h](),"vertical"==g.type&&(e=this[h]()-(e+this.find(".dynamic-range")[h]())),option.from_type="pixel"),null!==f&&f!==!1&&void 0!==f||(f=this.find(".dynamic-margin")[h]()+this.find(".dynamic-range")[h](),"vertical"==g.type&&(f=this[h]()-this.find(".dynamic-margin")[h]()),option.to_type="pixel");var i=this[h]();"pixel"==option.from_type?e=e*g.unit/i:"percent"==option.from_type?e=e*g.unit/100:"ziro_unit"==option.from_type?e-=g.min:"step_plus"==option.from_type&&(e=e*g.step+g.from),"pixel"==option.to_type?f=f*g.unit/i:"percent"==option.to_type?f=f*g.unit/100:"ziro_unit"==option.to_type?f-=g.min:"step_plus"==option.to_type&&(f=f*g.step+g.to);var j=Math.round(e/g.step)*g.step,k=Math.round(f/g.step)*g.step;k>g.unit&&(k=g.unit),k<0&&(k=0),j<0&&(j=0),j>k&&(j=k),k<j&&(k=j);var l=this.attr("id");l&&a('[data-range-bind="'+l+'"]').each(function(){var b=a(this).attr("data-range-value");"max"==b?a(this).val(g.min+k):"min"==b&&a(this).val(g.min+j)}),this.data("range-slider").from=j,this.data("range-slider").to=k,e=100*j/g.unit,f=100*k/g.unit;var m=f-e;"vertical"==g.type?this.find(".dynamic-margin").css(h,100-f+"%"):this.find(".dynamic-margin").css(h,e+"%"),this.find(".dynamic-range").css(h,m+"%")};var l=a("<div class='dynamic-margin'></div>"),m=a("<div class='dynamic-range'></div>"),n=b.call(this,"min"),o=b.call(this,"max");"max"==d?o.appendTo(m):"min"==d?n.appendTo(m):(o.appendTo(m),n.appendTo(m)),l.hide(),m.hide(),l.appendTo(this),m.appendTo(this),a(this).range(j,k),l.show(),m.show()})};var b=function(b){var c=a(this).data("range-slider"),d=this,e=a("<div class='"+b+"'></div>");return e.attr("tabindex","0"),e.unbind("mousedown.range-slider"),e.bind("mousedown.range-slider",function(){a(document).unbind("mousemove.range-slider"),a(document).bind("mousemove.range-slider",function(e){var f="vertical"==c.type?e.pageY:e.pageX,g="vertical"==c.type?a(d).offset().top:a(d).offset().left,h=f-g;h="vertical"==c.type?a(d).height()-h:h,"max"==b?a(d).range(null,h,{type:"pixel"}):a(d).range(h,null,{type:"pixel"})}).bind("mouseup.range-slider",function(){a(document).unbind("mouseup.range-slider"),a(document).unbind("mousemove.range-slider")})}).bind("mouseup",function(){a(document).unbind("mousemove.range-slider")}).bind("keydown.range-slider",function(b){var c,d;return c=1,d=null,a(this).is(".max")&&(c=null,d=1),38==b.keyCode||39==b.keyCode?(a(this).parents(".range-slider").range(c,d,{type:"step_plus"}),!1):37==b.keyCode||40==b.keyCode?(a(this).parents(".range-slider").range(c*-1,d*-1,{type:"step_plus"}),!1):void 0}),e}}(jQuery);
