...
function runCropper(_args)
{
	...
	{
		importCSS('/static/css/lib/cropper/cropper.min.css');
	}
	...
	$("#modal-preview .btn").off("click");
	$("#modal-preview .btn").on("click", function(_e)
	{
...
function cropAsCanvas(_cropper, _preview)
{
	...
	canvasImg.toBlob(function (_blob)
	{
		...
		var parentLi   = _preview.closest('li');
		...
		// set url for src of img
		_preview.attr('src', url);
		parentBox.attr('data-url', url);
		parentBox.closest('.preview').attr('data-url', url);

		// create form data to send image to server
		var formData = new FormData();
		formData.append('croppedImage', _blob);
		...
		$.ajax('',
		{
			...
			success: function (_e)
			{
				console.log('Upload success, this is response...');
				console.log(_e);
			},
			error: function ()
			{
