...
function fillAuto()
{
	// for each elemtns using autoList create variable
	$('.autoList').each(function(_el)
	{
		var listName = 'list' + $(this).attr('data-find') + _el;
		window[listName] = new Awesomplete(this,
		{
			// minChars: 1,
			autoFirst: true,
		...
		$(this).on('input', function(e)
		{
			...
			{
				fillDataList(this, window[listName]);
			}
		});
	});

	// on each autoList after select add as tag
	$(".autoList").on('awesomplete-selectcomplete',function()
	{
		addNewTags(this);
	});
}
