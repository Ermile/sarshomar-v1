...
class faq_text{
	public static $text = array(
		array(
			"id" 		=> 1,
			"title" 	=> "What is Sarshomar?",
			"text" 		=> [
			"Sarshomar is an integrative system to develop, manage and analyze online opinion polls in an efficient manner. Using Sarshomar is convenient, quick and without common complexities; its services are also available to the public.",
			"Using Sarshomar, do not be concerned about how to ask and conduct an analysis, and only concentrate on your question."]
			),
		array(
			"id" 		=> 2,
		...
		array(
			"id" 		=> 3,
			"title" 	=> "How can I upload my question?",
			"text" 		=> "Click on the Upload a new question icon or on the /Create icon to easily upload your question."
			),
		array(
			"id" 		=> 4,
		...
		array(
			"id" 		=> 5,
			"title" 	=> "How can I complete my registration in Sarshomar?",
			"text" 		=> [
			"Using Sarshomar Robot, due to its devoting a unique code to each user, is regarded as registration. However, to complete your registration and get it linked to Sarshomar After you cellphone number is uploaded, your account will be synchronized and it will be possible for you to log in the website.s website, after clicking on Dashboard icon or /dashboard command, select registration and synchronization option so that your cellphone number can be sent to the system.",
			"After you cellphone number is uploaded, your account will be synchronized and it will be possible for you to log in the website."]
			),
		array(
			"id" 		=> 6,
			"title" 	=> "Are there any limitations to use Sarshomar?",
			"text" 		=> [
			"The presupposition is that there are no limitations to use Sarshomar. However, to secure the quality of its services, and if special cases arise, Sarshomar is entitled to act upon the rules regarding the user accounts.",
			"We recommend that you read Sarshomar's terms and conditions of use."]
			),
		array(
			"id" 		=> 7,
			"title" 	=> "Are there any limitations regarding the number of answers given to questions?",
			"text" 		=> "No, there are no limitations for you to answer the questions."
			),
		array(
			"id" 		=> 8,
