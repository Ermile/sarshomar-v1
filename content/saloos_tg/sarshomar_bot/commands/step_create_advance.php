...
class step_create_advance
{
	...
	public static function step1($_text = null)
	{
		...
		$maker->message->add('alert-description', "📝 ".T_("چنانکه نیاز به ارایه‌ مقاله، خبر و اطلاعات تکمیلی در مورد سوال ثبت‌شده و نحوه پاسخ‌دهی دارید، دکمه توضیح را بفشارید."));
