...
private function transtext()
{
	...
	echo T_("Our answer sheets are absolutely correct, and we can measure the accuracy of answers");// Line 150
	...
	//-------------------------------------------content\template\static_elements.html
	echo T_("Elements");                                                              // Line 10
	echo T_("Input");                                                                 // Line 11
	echo T_("Basic");                                                                 // Line 12
	echo T_("Basic with placeholder");                                                // Line 18
	echo T_("Please enter text");                                                     // Line 39
	echo T_("Basic with placeholder and icon");                                       // Line 23
	echo T_("Primary with icon");                                                     // Line 29
	echo T_("Primary with icon and placeholder");                                     // Line 36
	echo T_("Success");                                                               // Line 43
	echo T_("Why men marry women?");                                                  // Line 77
	echo T_("Warn");                                                                  // Line 50
	echo T_("Fail");                                                                  // Line 57
	echo T_("Disabled");                                                              // Line 64
	echo T_("Tags");                                                                  // Line 291
	echo T_("Add");                                                                   // Line 296
	...
	//-------------------------------------------content\template\static_visitors.html
	echo T_("Visitors");                                                              // Line 5

	//------------------------------------------------------content_u\add\display.html
	echo T_("Multiple Choice");                                                       // Line 20
	echo T_("Descriptive");                                                           // Line 21
	echo T_("Numerical");                                                             // Line 25
	echo T_("Poll type");                                                             // Line 36
	echo T_("Title");                                                                 // Line 178
	echo T_("Content");                                                               // Line 188
	echo T_("Answer type");                                                           // Line 93
	echo T_("True answer");                                                           // Line 107
	echo T_("Point");                                                                 // Line 114
	echo T_("Answer one");                                                            // Line 88
	echo T_("Answer Two");                                                            // Line 119
	echo T_("Language");                                                              // Line 183
	echo T_("Publish date");                                                          // Line 193
	echo T_("Can update");                                                            // Line 138
	echo T_("Can remove");                                                            // Line 143
	echo T_("Can stop");                                                              // Line 148
	echo T_("Summary");                                                               // Line 155
	echo T_("Edit");                                                                  // Line 205
	echo T_("Write your tag and press enter to add new keyword to content");          // Line 290
	echo T_("Enter Tags here");                                                       // Line 294
	echo T_("Enter Tags");                                                            // Line 295
