...
private function transtext()
{
	...
	echo T_("Save Answer");                                                           // Line 96
	echo T_("Ask Me");                                                                // Line 18
	echo T_("result");                                                                // Line 110
	echo T_("Similar Questions");                                                     // Line 132
	echo T_("There is no similar post");                                              // Line 140
	echo T_("Poll timespan");                                                         // Line 158
	echo T_("to");                                                                    // Line 161
	echo T_("Not set");                                                               // Line 197
	echo T_("Status");                                                                // Line 11
	echo T_("Keyword");                                                               // Line 179
	echo T_("Statistical population");                                                // Line 191
	echo T_("There is nothing to display!");                                          // Line 242
	echo T_("What is your opinion? Please rate this poll.");                          // Line 253
	echo T_("Submit");                                                                // Line 26
	echo T_("Continue");                                                              // Line 310
	...
	echo T_("Request, offer, criticism and appreciation");                            // Line 7
	...
	echo T_("We are inestimable");                                                    // Line 24
	echo T_("Ask and Answer with Sarshomar");                                         // Line 8
	echo T_("Sarshomar is jumping...");                                               // Line 9
	echo T_("Inspection and Answer");                                                 // Line 27
	echo T_("Then if we were inestimable, Signup!");                                  // Line 28
	echo T_("Verify your account");                                                   // Line 19
	echo T_("Try Before Register");                                                   // Line 43
	...
	echo T_("Possibility of using new and modern methods for asking questions.");     // Line 14
	...
	echo T_("Possibility of exporting results in any format of your choice.");        // Line 38
	echo T_("Observe the result in separation of Statistical population");            // Line 49
	echo T_("Receive comparing graph and tables separately from   requested option. ");// Line 50
	echo T_("Online test");                                                           // Line 61
	echo T_("Easily organize online test without any limitation.");                   // Line 62
	...
	echo T_("Providing services through Telegram");                                   // Line 157
	echo T_("Use Sarshomar bot in your Telegram channels and groups");                // Line 158
	echo T_("Determining the Statistical population");                                // Line 169
	echo T_("Compare from sightly Statistical population. ");                         // Line 170
	...
	echo T_("Organizations and Companies");                                           // Line 44
	echo T_("Exprience evaluation of current status, measuring customers satisfaction, conducting market research and promoting services level by the help of Sarshomar.");// Line 41
	...
	echo T_("Advertising Agencies");                                                  // Line 62
	echo T_("By offering new advertising solutions and targeted advertsing, get your customers excited.");// Line 63
	...
	echo T_("notification");                                                          // Line 56
	echo T_("upload");                                                                // Line 62
	echo T_("starred");                                                               // Line 68
	echo T_("numerical");                                                             // Line 74
	echo T_("sort");                                                                  // Line 80
	echo T_("survey time");                                                           // Line 88
	...
	echo T_("Married");                                                               // Line 39
	echo T_("employment");                                                            // Line 135
	echo T_("employee");                                                              // Line 138
	echo T_("Unemployed");                                                            // Line 52
	echo T_("Retired");                                                               // Line 54
	echo T_("gender");                                                                // Line 144
	echo T_("male");                                                                  // Line 147
	echo T_("female");                                                                // Line 148
	echo T_("graduation");                                                            // Line 152
	echo T_("illiterate");                                                            // Line 155
	echo T_("undergraduate");                                                         // Line 156
	echo T_("graduate");                                                              // Line 157
	echo T_("under diploma");                                                         // Line 158
	echo T_("diploma");                                                               // Line 159
	echo T_("2 year college");                                                        // Line 69
	echo T_("bachelor");                                                              // Line 161
	echo T_("master");                                                                // Line 162
	echo T_("phd");                                                                   // Line 163
	echo T_("other");                                                                 // Line 164
	echo T_("country");                                                               // Line 168
	...
	echo T_("Allow user to sort answers");                                            // Line 16
	...
	echo T_("Show result in home page");                                              // Line 18
	echo T_("Category");                                                              // Line 22
	echo T_("Article");                                                               // Line 32
	echo T_("Language");                                                              // Line 57
	echo T_("Short URL");                                                             // Line 62

	//-----------------------------------------------------content_u/home/display.html
	echo T_("Your profile is not complete!");                                         // Line 14
	echo T_("Thank you for completing profile");                                      // Line 18
