...
private function transtext()
{
	...
	echo T_("marriade");                                                              // Line 131
	echo T_("employment");                                                            // Line 135
	echo T_("employee");                                                              // Line 138
	echo T_("unemployee");                                                            // Line 139
	echo T_("retired");                                                               // Line 140
	...
	echo T_("Cost");                                                                  // Line 44
	echo T_("Tomans");                                                                // Line 64
	echo T_("Total cash");                                                            // Line 64
