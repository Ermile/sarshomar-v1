...
private function transtext()
{
	...
	echo T_("Name");                                                                  // Line 33
	echo T_("Full Name");                                                             // Line 20
	echo T_("Mobile");                                                                // Line 211
	...
	//---------------------------------------------------content\home\display.bak.html
	echo T_("Focus on your question. Do not be too concerned about how to ask or analyze.");// Line 85
	echo T_("Equipped with an integrated platform, Sarshomar has made it possible for you to ask your questions via any means.");// Line 85
	echo T_("Try Before Register");                                                   // Line 48
	echo T_("To enter into the Sarshomar society win iPhone");                        // Line 19
	echo T_("vote");                                                                  // Line 95
	echo T_("Sarshomar Society Distributtion");                                       // Line 132
	...
	echo T_("Comments");                                                              // Line 72
	echo T_("Votes");                                                                 // Line 26
	echo T_("Date");                                                                  // Line 13
	echo T_("Skip");                                                                  // Line 222
	echo T_("Media");                                                                 // Line 28
	echo T_("Filter");                                                                // Line 132
	echo T_("Asked");                                                                 // Line 30
	echo T_("Rank");                                                                  // Line 324
	echo T_("count_filter");                                                          // Line 32
	echo T_("count_ad");                                                              // Line 33
	echo T_("count_money");                                                           // Line 34
	echo T_("count_report");                                                          // Line 35
	echo T_("count_view");                                                            // Line 36
	echo T_("count_other");                                                           // Line 37
	echo T_("count_sarshomar");                                                       // Line 38
	echo T_("count_ago");                                                             // Line 39
	echo T_("count_admin");                                                           // Line 40
	echo T_("count_vip");                                                             // Line 41
	echo T_("(Untitled)");                                                            // Line 64
	echo T_("No Result Found");                                                       // Line 45

	//---------------------------------------------------content\knowledge\layout.html
	echo T_("Questions");                                                             // Line 18
	echo T_("Gender");                                                                // Line 376
	echo T_("Male");                                                                  // Line 379
	echo T_("Female");                                                                // Line 380
	echo T_("Marital");                                                               // Line 61
	echo T_("Single");                                                                // Line 387
	echo T_("Married");                                                               // Line 388
	echo T_("Employment");                                                            // Line 68
	echo T_("Employee");                                                              // Line 296
	echo T_("Unemployed");                                                            // Line 297
	echo T_("Retired");                                                               // Line 298
	...
	echo T_("Graduation");                                                            // Line 239
	echo T_("Illiterate");                                                            // Line 242
	echo T_("Undergraduate");                                                         // Line 243
	echo T_("Graduate");                                                              // Line 244
	echo T_("Under Diploma");                                                         // Line 263
	echo T_("Diploma");                                                               // Line 264
	echo T_("2 Year College");                                                        // Line 265
	echo T_("Bachelor");                                                              // Line 266
	echo T_("Master");                                                                // Line 267
	echo T_("PHD");                                                                   // Line 268
	echo T_("Other");                                                                 // Line 269
	echo T_("Country");                                                               // Line 339
	echo T_("Age");                                                                   // Line 116
	echo T_("Province");                                                              // Line 343
	echo T_("Religion");                                                              // Line 231
	...
	echo T_("Login or Try");                                                          // Line 68
	echo T_("e.g: +989120000000");                                                    // Line 72
	echo T_("Login");                                                                 // Line 6
	echo T_("Try Sarshomar");                                                         // Line 80
	echo T_("Next →");                                                                // Line 89
	echo T_("← Back");                                                                // Line 89
	echo T_("Done");                                                                  // Line 89
	...
	echo T_("Spam");                                                                  // Line 10
	echo T_("Breaking The Law");                                                      // Line 34
	echo T_("Privacy Issue");                                                         // Line 35
	echo T_("Not Interested");                                                        // Line 36
	echo T_("Your are our Guest!");                                                   // Line 48
	echo T_("Read More");                                                             // Line 212
	echo T_("There is no option!");                                                   // Line 167
	echo T_("Previous");                                                              // Line 183
	echo T_("Save Answer");                                                           // Line 279
	echo T_("Next");                                                                  // Line 9
	echo T_("You can select just two options.");                                      // Line 223
	echo T_("I am not willing to answer");                                            // Line 270
	echo T_("Ask Me");                                                                // Line 30
	echo T_("There is no data to draw chart!");                                       // Line 299
	echo T_("Item");                                                                  // Line 325
	echo T_("Vote");                                                                  // Line 326
	echo T_("Ratio");                                                                 // Line 327
	echo T_("Total");                                                                 // Line 278
	echo T_("Person");                                                                // Line 345
	echo T_("Similar Questions");                                                     // Line 375
	echo T_("Latest Questions");                                                      // Line 368
	echo T_("There is no similar post");                                              // Line 376
	echo T_("Status and period of publish");                                          // Line 396
	echo T_("People voted to this poll");                                             // Line 403
	echo T_("Skip/Votes");                                                            // Line 416
	echo T_("Privacy");                                                               // Line 424
	echo T_("Author");                                                                // Line 431
	echo T_("Range");                                                                 // Line 438
	echo T_("All society of Sarshomar");                                              // Line 440
	echo T_("Poll timespan");                                                         // Line 445
	echo T_("to");                                                                    // Line 109
	echo T_("Not set");                                                               // Line 487
	echo T_("Keyword");                                                               // Line 456
	echo T_("Audiences of this poll");                                                // Line 472
	echo T_("Tree");                                                                  // Line 308
	echo T_("You've answered to this poll");                                          // Line 492
	echo T_("There is nothing to display!");                                          // Line 536
	echo T_("What is your opinion? Please rate this poll.");                          // Line 545
	echo T_("Submit");                                                                // Line 89
	echo T_("Continue");                                                              // Line 600
	echo T_("Refresh Chart");                                                         // Line 637
	echo T_("VIP Value");                                                             // Line 654
	echo T_("Select");                                                                // Line 662
	echo T_("stop");                                                                  // Line 25 Seperate
	echo T_("pause");                                                                 // Line 23 Seperate
	echo T_("trash");                                                                 // Line 665
	echo T_("publish");                                                               // Line 689
	echo T_("draft");                                                                 // Line 694
	echo T_("enable");                                                                // Line 75
	echo T_("disable");                                                               // Line 76
	echo T_("deleted");                                                               // Line 65
	echo T_("schedule");                                                              // Line 671
	echo T_("expired");                                                               // Line 66
	echo T_("awaiting");                                                              // Line 161
	echo T_("filtered");                                                              // Line 68
	echo T_("blocked");                                                               // Line 69
	echo T_("spam");                                                                  // Line 70
	echo T_("violence");                                                              // Line 677
	echo T_("pornography");                                                           // Line 678
	echo T_("other");                                                                 // Line 389 Seperate
	echo T_("People Voted");                                                          // Line 718
	echo T_("You");                                                                   // Line 719
	echo T_("People");                                                                // Line 46
	echo T_("Lottery");                                                               // Line 740
	...
	echo T_("Win an iPhone by entering Sarshomar's society");                         // Line 6
	echo T_("Sarshomar gifts");                                                       // Line 12
	echo T_("Register gift");                                                         // Line 16
	...
	//--------------------------------------content\template\static\logo\home-old.html
	...
	echo T_("By the same token, we are always looking for creative and motivated Iranian youths in order to make the best and be effective in cooperation with them.");// Line 41
	echo T_("Join us and grow in a different location.");                             // Line 42
	echo T_("Presenting Valid Statistics and Qualitative Promotion of Society");      // Line 45
	echo T_("A large proportion of Sarshomar's questions address the problems in society, attempting to solve them.");// Line 47
	echo T_("The given statistics are presented in a simple and distinct manner accompanied by graphs in order to be understood rapidly by the general public.");// Line 48
	echo T_("Besides, regarding the qualitative promotion of society, some articles are published to present strategies in this regard.");// Line 49
	echo T_("Customer Care and Complete Satisfaction");                               // Line 52
	echo T_("Attracting people's participation as well as having their valuable presence has always been a great honor for Sarshomar and to appreciate your support, in return, Sarshomar presents services to promote customer satisfaction.");// Line 54
	echo T_("These services are presented in different time intervals and are aimed at costomer care mission and appreciation of your valuable presence.");// Line 55
	...
	//--------------------------------------content_admin\attachments\display.bak.html
	echo T_("Show");                                                                  // Line 34
	echo T_("delete");                                                                // Line 37
	echo T_("Accept ALL");                                                            // Line 45

	//------------------------------------------content_admin\attachments\display.html
	echo T_("Accept All");                                                            // Line 50
	...
	echo T_("from");                                                                  // Line 108
	echo T_("rate");                                                                  // Line 110
	echo T_("roundtype");                                                             // Line 111
	echo T_("Please select one item");                                                // Line 42
	echo T_("up");                                                                    // Line 34
	echo T_("down");                                                                  // Line 35
	echo T_("round");                                                                 // Line 112
	echo T_("wagestatic");                                                            // Line 113
	echo T_("wage");                                                                  // Line 114
	echo T_("status");                                                                // Line 10
	echo T_("desc");                                                                  // Line 12
	echo T_("meta");                                                                  // Line 18
	echo T_("createdate");                                                            // Line 118
	...
	echo T_("Caller");                                                                // Line 18
	echo T_("Meta");                                                                  // Line 43
	echo T_("Count");                                                                 // Line 19
	echo T_("Date Modified");                                                         // Line 20

	//-------------------------------------------------content_admin\logs\display.html
	echo T_("User");                                                                  // Line 368
	echo T_("Log data");                                                              // Line 17
	echo T_("Desc");                                                                  // Line 156
	echo T_("User data");                                                             // Line 33
	echo T_("Find this user in logs");                                                // Line 34
	echo T_("Log meta");                                                              // Line 42

	//----------------------------------------------content_admin\main\layout-xhr.html

	//--------------------------------------------------content_admin\main\layout.html
	echo T_("Admin");                                                                 // Line 28
	echo T_("All");                                                                   // Line 44
	echo T_("Logs");                                                                  // Line 9
	echo T_("Logitems");                                                              // Line 8
	echo T_("Transaction Items");                                                     // Line 11
	echo T_("Exchange rates");                                                        // Line 12
	echo T_("Units");                                                                 // Line 37
	echo T_("Users");                                                                 // Line 13
	echo T_("Users Dashboards");                                                      // Line 16
	echo T_("Refresh Numbers");                                                       // Line 17
	echo T_("Attachments");                                                           // Line 18
	...
	echo T_("All Poll");                                                              // Line 4
	echo T_("Sarshomar poll");                                                        // Line 5
	echo T_("People poll");                                                           // Line 6
	...
	echo T_("Datemodified");                                                          // Line 111
	echo T_("Enddate");                                                               // Line 112

	//-----------------------------------------content_admin\transactions\display.html
	echo T_("Display name");                                                          // Line 16
	echo T_("budgetbefore");                                                          // Line 20
	echo T_("budget");                                                                // Line 18

	//------------------------------------------------content_admin\units\display.html

	//---------------------------------------content_admin\userdashboards\display.html
	echo T_("Displayname");                                                           // Line 15
	echo T_("poll_answered");                                                         // Line 17
	echo T_("poll_skipped");                                                          // Line 18
	echo T_("my_poll");                                                               // Line 19
	echo T_("my_poll_answered");                                                      // Line 20
	echo T_("my_poll_skipped");                                                       // Line 21
	echo T_("user_referred");                                                         // Line 22
	echo T_("user_verified");                                                         // Line 23
	echo T_("comment_count");                                                         // Line 24
	echo T_("draft_count");                                                           // Line 25
	echo T_("publish_count");                                                         // Line 26
	echo T_("awaiting_count");                                                        // Line 27
	echo T_("fav");                                                                   // Line 458 Seperate
	echo T_("like");                                                                  // Line 29
	echo T_("Find logs of users");                                                    // Line 27
	echo T_("Login by this mobile");                                                  // Line 31

	//------------------------------------------------content_admin\users\display.html
	echo T_("user_mobile");                                                           // Line 14
	echo T_("user_username");                                                         // Line 15
	echo T_("user_displayname");                                                      // Line 16
	echo T_("user_status");                                                           // Line 17
	echo T_("user_port");                                                             // Line 19
	echo T_("user_verify");                                                           // Line 20
	echo T_("user_language");                                                         // Line 21
	...
	//----------------------------content_api\v1\doc\template\profile\description.html
	echo T_("Add profile");                                                           // Line 1
	echo T_("Add profile via Sarshomar API");                                         // Line 3

	//----------------------------------content_api\v1\doc\template\profile\index.html

	//----------------------------------content_api\v1\doc\template\profile\table.html
	echo T_("The user language");                                                     // Line 10
	echo T_("The user unit");                                                         // Line 15
	echo T_("The user gender");                                                       // Line 20
	echo T_("The user marrital");                                                     // Line 25
	echo T_("The user graduation");                                                   // Line 30
	echo T_("The user degree");                                                       // Line 35
	echo T_("The user range");                                                        // Line 40
	echo T_("The user employmentstatus");                                             // Line 45
	echo T_("The user housestatus");                                                  // Line 50
	...
	//-------------------------------------content_election\admin\candida\display.html
	echo T_("Candida List");                                                          // Line 5
	echo T_("id");                                                                    // Line 7
	echo T_("election");                                                              // Line 131 Seperate
	echo T_("Family");                                                                // Line 183
	echo T_("Father");                                                                // Line 67
	echo T_("Fame");                                                                  // Line 71
	echo T_("Nationalcode");                                                          // Line 14
	echo T_("Brith date");                                                            // Line 15
	echo T_("Election code");                                                         // Line 83
	echo T_("File_url");                                                              // Line 18
	echo T_("File_url_2");                                                            // Line 19
	echo T_("Win url");                                                               // Line 20
	echo T_("Edit candida data");                                                     // Line 43
	echo T_("Add new candida");                                                       // Line 45
	echo T_("election_id");                                                           // Line 49
	echo T_("name");                                                                  // Line 15
	echo T_("family");                                                                // Line 286 Seperate
	echo T_("father");                                                                // Line 17
	echo T_("fame");                                                                  // Line 70
	echo T_("birthdate");                                                             // Line 19
	echo T_("Birth date");                                                            // Line 75
	echo T_("nationalcode");                                                          // Line 18
	echo T_("National code");                                                         // Line 79
	echo T_("electioncode");                                                          // Line 20
	echo T_("file_url");                                                              // Line 86
	echo T_("file_url_2");                                                            // Line 90
	echo T_("win_url");                                                               // Line 94
	echo T_("active");                                                                // Line 486 Seperate
	echo T_("cancel");                                                                // Line 101
	echo T_("Save");                                                                  // Line 549
	echo T_("Update");                                                                // Line 86

	//---------------------------------------------content_election\admin\display.html
	echo T_("Admin Election");                                                        // Line 5
	echo T_("Election");                                                              // Line 8
	echo T_("Candida");                                                               // Line 111

	//------------------------------------content_election\admin\election\display.html
	echo T_("Election list");                                                         // Line 5
	echo T_("Eligible");                                                              // Line 75
	echo T_("Voted");                                                                 // Line 44
	echo T_("Invalid");                                                               // Line 47
	echo T_("Cash");                                                                  // Line 152
	echo T_("Branchs");                                                               // Line 91
	echo T_("First vote male count");                                                 // Line 17
	echo T_("First vote female count");                                               // Line 18
	echo T_("Signuped");                                                              // Line 103
	echo T_("Candida count");                                                         // Line 21
	echo T_("Start time");                                                            // Line 115
	echo T_("End_time");                                                              // Line 23
	echo T_("Election date");                                                         // Line 123
	echo T_("Jalali year");                                                           // Line 127
	echo T_("Year");                                                                  // Line 131
	echo T_("En url");                                                                // Line 20
	echo T_("Fa url");                                                                // Line 21
	echo T_("Cat");                                                                   // Line 143
	echo T_("Win");                                                                   // Line 146
	echo T_("Edit election data");                                                    // Line 64
	echo T_("Add new election");                                                      // Line 66
	echo T_("Cashs");                                                                 // Line 87
	echo T_("First vote male");                                                       // Line 95
	echo T_("First vote female");                                                     // Line 99
	echo T_("End time");                                                              // Line 119
	echo T_("running");                                                               // Line 162
	...
	echo T_("Edit report resutl");                                                    // Line 33
	echo T_("Add new report");                                                        // Line 35

	//----------------------------------------content_election\data\report\result.html
	echo T_("Click to edit");                                                         // Line 9
	echo T_("Level");                                                                 // Line 35
	echo T_("Number");                                                                // Line 12

	//-----------------------------------content_election\data\result\city_result.html
	echo T_("Add city result of election");                                           // Line 3

	//---------------------------------------content_election\data\result\display.html

	//----------------------------------------------content_election\home\display.html
	echo T_("Candidates' List");                                                      // Line 98
	...
	echo T_("Education");                                                             // Line 179
	echo T_("Marrital");                                                              // Line 384
	echo T_("Employed");                                                              // Line 71
	echo T_("Degree");                                                                // Line 260
	echo T_("Under diploma");                                                         // Line 83
	echo T_("2 year college");                                                        // Line 87
	echo T_("Age Range");                                                             // Line 99
	echo T_("Under 13");                                                              // Line 102
	echo T_("14-17");                                                                 // Line 104
	echo T_("18-24");                                                                 // Line 106
	echo T_("25-30");                                                                 // Line 108
	echo T_("31-44");                                                                 // Line 110
	...
	echo T_("Class");                                                                 // Line 91
	echo T_("The poll class");                                                        // Line 93
	echo T_("Hide Results");                                                          // Line 142
	echo T_("Show Results");                                                          // Line 105
	echo T_("Price");                                                                 // Line 118
	echo T_("Toman");                                                                 // Line 6
	echo T_("Register Question");                                                     // Line 122
	echo T_("Society");                                                               // Line 127
	echo T_("Total Price");                                                           // Line 147
	echo T_("Balance");                                                               // Line 158
	echo T_("Charge Account");                                                        // Line 164
	echo T_("Publish it");                                                            // Line 165
	echo T_("Draft it");                                                              // Line 165
	...
	echo T_("None");                                                                  // Line 104
	echo T_("Published Polls");                                                       // Line 84
	echo T_("Likes");                                                                 // Line 119
	echo T_("Activities Report");                                                     // Line 132
	echo T_("Create new poll");                                                       // Line 147
	echo T_("My polls");                                                              // Line 150
	echo T_("Ask me");                                                                // Line 153
	echo T_("Credit");                                                                // Line 162
	echo T_("Recent Activities");                                                     // Line 175
	echo T_("You've had no activities yet");                                          // Line 177
	echo T_("Question Answered");                                                     // Line 215
	echo T_("Remained");                                                              // Line 217
	echo T_("Answered");                                                              // Line 227
	...
	echo T_("Connect another account");                                               // Line 131
	echo T_("Connect to your Twitter and Github accounts with Sarshomar. We only use this information to verify your account. We'll never spam you, post on your behalf or do anything sketchy like that.");// Line 132
	echo T_("Personal");                                                              // Line 374
	echo T_("Job");                                                                   // Line 180
	echo T_("Location");                                                              // Line 181
	echo T_("Favorites");                                                             // Line 184
	echo T_("Profile Photo");                                                         // Line 193
	echo T_("First Name");                                                            // Line 195
	echo T_("Last Name");                                                             // Line 199
	echo T_("Display Name");                                                          // Line 203
	echo T_("Birth Year");                                                            // Line 215
	echo T_("Birth Month");                                                           // Line 219
	echo T_("Birthday");                                                              // Line 223
	echo T_("UI Language");                                                           // Line 227
	echo T_("Please Select One Item");                                                // Line 407
	echo T_("Education Type");                                                        // Line 248
	echo T_("Academic");                                                              // Line 251
	echo T_("Howzeh");                                                                // Line 273
	echo T_("Course");                                                                // Line 256
	echo T_("Howzeh Degree");                                                         // Line 277
	echo T_("Howzeh Course");                                                         // Line 281
	echo T_("Education City");                                                        // Line 285
	echo T_("Employment Status");                                                     // Line 293
	echo T_("Industry");                                                              // Line 302
	echo T_("Company");                                                               // Line 306
	echo T_("Job City");                                                              // Line 310
	echo T_("Job Title");                                                             // Line 314
	echo T_("Birth");                                                                 // Line 322
	echo T_("Birth Country");                                                         // Line 324
	echo T_("Birth Province");                                                        // Line 328
	echo T_("Birth City");                                                            // Line 332
	echo T_("Current");                                                               // Line 337
	echo T_("Village");                                                               // Line 351
	echo T_("House Status");                                                          // Line 355
	echo T_("Owner");                                                                 // Line 358
	echo T_("Tenant");                                                                // Line 359
	echo T_("Homeless");                                                              // Line 360
	echo T_("Girl Child");                                                            // Line 392
	echo T_("Boy Child");                                                             // Line 396
	echo T_("Internet Usage");                                                        // Line 405
	echo T_("Low");                                                                   // Line 408
	echo T_("Mid");                                                                   // Line 409
	echo T_("High");                                                                  // Line 410
	echo T_("Skills");                                                                // Line 414
	echo T_("Languages");                                                             // Line 418
	echo T_("Books");                                                                 // Line 422
	echo T_("Writers");                                                               // Line 433
	echo T_("Films");                                                                 // Line 444
	echo T_("Actors");                                                                // Line 455
	echo T_("Genre");                                                                 // Line 466
	echo T_("Musics");                                                                // Line 477
	echo T_("Artists");                                                               // Line 488
	echo T_("Sports");                                                                // Line 499
	echo T_("Sportmans");                                                             // Line 510
	echo T_("Habbits");                                                               // Line 521
	echo T_("Devices");                                                               // Line 532
	echo T_("Cancel");                                                                // Line 549
