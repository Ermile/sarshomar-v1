...
private function transtext()
{
	...
	//----------------------------------content/template/static/features/guest-fa.html
	...
	//------------------------content/template/static/features/anatomical-answers.html
	echo T_("Anatomical Answers");                                                    // Line 6

	//-----------------------content/template/static/features/try-before-register.html
	echo T_("Try before register");                                                   // Line 6

	//----------------------------content/template/static/features/knowledge-base.html
	echo T_("Knowledge Base");                                                        // Line 112

	//----------------------content/template/static/features/population-breakdown.html
	echo T_("Population Breakdown");                                                  // Line 6

	//---------------------content/template/static/features/privatization-results.html
	echo T_("Privatization Results");                                                 // Line 6

	//---------------------------content/template/static/features/multi-languages.html

	//--------------------------content/template/static/features/valid-population.html
	echo T_("Valid Population");                                                      // Line 6

	//----------------------------content/template/static/features/export-results.html
	echo T_("Export Results");                                                        // Line 6

	//---------------------content/template/static/features/demographic-targeting.html
	echo T_("Demographic targeting");                                                 // Line 6

	//---------------------------content/template/static/features/no-interference.html
	...
	echo T_("Developers and Webmasters");                                             // Line 83
	...
	echo T_("Exprience evaluation of current status, measuring customers satisfaction, conducting market research and promoting services level by the help of Sarshomar.");// Line 45
	echo T_("Universities and Research Institutes");                                  // Line 57
	echo T_("Have access to accurate information and reduce the cost of gathering and processing data by giving tests, polls and assessments in Sarshomar.");// Line 58
	echo T_("Advertising Agencies");                                                  // Line 70
	echo T_("By offering new advertising solutions and targeted advertsing, get your customers excited.");// Line 71
	echo T_("By using API, enjoy Sarshomar's features and forget the concern of opinion polls.");// Line 84

	//---------------------content/template/static/target/advertising-agencies-fa.html
	...
	//------------------------content/template/static/target/advertising-agencies.html
	...
	//---------------------------content/template/static/social-responsibility-fa.html
	...
	echo T_("survey");                                                                // Line 62
	echo T_("gender");                                                                // Line 63
	echo T_("privacy");                                                               // Line 64
	echo T_("total");                                                                 // Line 65
