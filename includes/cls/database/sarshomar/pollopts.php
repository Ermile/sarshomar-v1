...
class pollopts
{
	...
	public $title          = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'title'           ,'type'=>'varchar@700'];
	public $key            = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'key'             ,'type'=>'smallint@3'];
	public $type           = ['null'=>'NO'  ,'show'=>'YES'     ,'label'=>'type'            ,'type'=>'enum@select,emoji,descriptive,upload,range,notification'];
	public $subtype        = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'subtype'         ,'type'=>'varchar@200'];
	public $true           = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'true'            ,'type'=>'bit@1!b'0''];
	public $groupscore     = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'groupscore'      ,'type'=>'varchar@50'];
	...
	public $profile        = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'profile'         ,'type'=>'varchar@200'];
	...
	{
		$this->form('#title')->type('textarea')->name('title')->maxlength('700');
	}
	//--------------------------------------------------------------------------------id
	public function key()
	{
	...
	{
		$this->form()->type('textarea')->name('subtype')->maxlength('200');
	}
	//--------------------------------------------------------------------------------id
	...
	{
		$this->form()->type('text')->name('groupscore')->maxlength('50');
	}
	//--------------------------------------------------------------------------------id
	...
	{
		$this->form()->type('textarea')->name('profile')->maxlength('200');
	}
	//--------------------------------------------------------------------------------id
