...
class pollstats
{
	...
	public $degree           = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'degree'          ,'type'=>'mediumtext@'];
	...
	public $range            = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'range'           ,'type'=>'mediumtext@'];
	public $age              = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'age'             ,'type'=>'mediumtext@'];
	public $country          = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'country'         ,'type'=>'mediumtext@'];
	public $province         = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'province'        ,'type'=>'mediumtext@'];
	public $city             = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'city'            ,'type'=>'mediumtext@'];
	public $language         = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'language'        ,'type'=>'mediumtext@'];
	public $religion         = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'religion'        ,'type'=>'text@'];
	public $course           = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'course'          ,'type'=>'mediumtext@'];
	public $industry         = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'industry'        ,'type'=>'mediumtext@'];
